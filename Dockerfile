...
# 设置工作目录和启动命令
WORKDIR /app
CMD java -jar employee.jar --server.port=8431 & java -jar user.jar --server.port=8430 & java -jar algorithm.jar
--server.port=8432 & java -jar gateway.jar --server.port=80
